<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-end border-0 shadow-lg py-2" style="min-width: 160px; border-radius: 12px;">
        ...
        @can('setting.room.edit')
            <a href="{{ route('setting.room.edit', ['id' => $row->id]) }}" onclick="editBaseUnit(event)"  class="dropdown-item py-2 px-3 d-flex align-items-center">
