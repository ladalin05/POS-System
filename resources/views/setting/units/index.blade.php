<x-app-layout>
    ...
    <x-basic.breadcrumb>
        <x-slot name="title">
            <h2 class="mb-0" >Units List</h2>
            <span style="color: #646B72; font-size: 14px;">Manage your Units</span>
        </x-slot>
        <div class="header-actions d-flex align-items-center gap-2">
            ...
            <a href="{{ route('setting.units.create') }}" onclick="addData(event)" class="btn btn-add-user d-flex align-items-center gap-2 text-white">
