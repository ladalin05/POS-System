<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-end border-0 shadow-lg py-2" style="min-width: 160px; border-radius: 12px;">
        ...
        @can('setting.floor.edit')
            <a href="{{ route('setting.floor.edit', ['id' => $row->id]) }}" onclick="editBaseUnit(event)"  class="dropdown-item py-2 px-3 d-flex align-items-center">
        ...
        @can('setting.base-units.delete')
            @can('setting.base-units.edit')
    ...
    $(document).on("click", ".data_remove", function(e){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "{{ route('setting.base-units.delete') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: id
