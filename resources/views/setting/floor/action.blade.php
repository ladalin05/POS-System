<div class="d-inline-flex dropdown ms-2">
    ...
    <div class="dropdown-menu dropdown-menu-end">
        @can('setting.floor.edit')
            <a href="{{ route('setting.floor.edit', $a->id) }}" class="dropdown-item">
                <i class="ph ph-pencil me-2"></i>
                {{ __('global.edit') }}
            </a>
        @endcan
        @can('setting.floor.delete')
            <div class="dropdown-divider"></div>
            <a href="{{ route('setting.floor.delete', $a->id) }}" class="dropdown-item" onclick="deleteRecord(event)">
