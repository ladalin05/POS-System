<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-end border-0 shadow-lg py-2" style="min-width: 160px; border-radius: 12px;">
        ...
        @can('setting.unit_convert.edit')
            <a href="{{ route('setting.unit_convert.edit', $row->id) }}" class="dropdown-item py-2 px-3 d-flex align-items-center">
        ...
        @can('setting.unit_convert.delete')
            ...
            <a href="{{ route('setting.unit_convert.delete', $row->id) }}" 
