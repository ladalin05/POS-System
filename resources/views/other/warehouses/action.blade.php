<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-end border-0 shadow-lg py-2" style="min-width: 160px; border-radius: 12px;">
        ...
        @can('other.warehouses.update')
            <a href="{{ route('other.warehouses.update', $row->id) }}" class="dropdown-item py-2 px-3 d-flex align-items-center">
        ...
        @can('other.warehouses.delete')
            @can('other.warehouses.update')
                <div class="dropdown-divider my-1 opacity-50"></div>
            @endcan

            <a href="{{ route('other.warehouses.delete', $row->id) }}" 
