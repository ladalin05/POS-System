<x-app-layout>
    <x-basic.breadcrumb>
        <x-slot name="title">
            <h2 class="mb-0" >Stock Transfer List</h2>
            <span style="color: #646B72; font-size: 14px;">Manage your Stock Transfers</span>
        </x-slot>
        ...
        <div class="header-actions d-flex align-items-center gap-2">
            ...
            <a href="{{ route('stocks.transfer.create') }}" class="btn btn-add-user d-flex align-items-center gap-2 text-white">
