<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-end border-0 shadow-lg py-2" style="min-width: 160px; border-radius: 12px;">
        ...
        @can('stock.manage.edit')
            <a href="{{ route('stock.manage.edit', $row->id) }}" class="dropdown-item py-2 px-3 d-flex align-items-center">
        ...
        @can('stock.manage.delete')
            @can('stock.manage.edit')
                <div class="dropdown-divider my-1 opacity-50"></div>
            @endcan

            <a href="{{ route('stock.manage.delete', $row->id) }}" 
