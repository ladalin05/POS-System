<div class="d-inline-flex dropdown ms-2">
    ...
    <div class="dropdown-menu dropdown-menu-end">
        @can('product.categories.edit')
            <a href="{{ route('product.categories.edit', $a->id) }}" class="dropdown-item">
        ...
        @can('product.categories.delete')
            ...
            <a href="{{ route('product.categories.delete', $a->id) }}" class="dropdown-item" onclick="deleteRecord(event)">
