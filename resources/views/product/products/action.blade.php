...
<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end shadow-sm">
        ...
        <li>
            <a href="{{ route('products.products.update', ['id' => $row->id]) }}" class="dropdown-item">
                <i class="ph ph-pencil-simple me-2 text-success"></i>
                Edit
            </a>
        </li>
        <li>
            <button type="button" class="dropdown-item text-danger data_remove" data-url="{{ route('products.products.delete', ['id' => $row->id]) }}" onclick="deleteData(event)">
