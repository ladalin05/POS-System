<div class="d-inline-flex dropdown ms-2">
    ...
    <div class="dropdown-menu dropdown-menu-end">
        @can('people.saleman.edit')
            <a href="{{ route('people.saleman.edit', $a->id) }}" class="dropdown-item">
                <i class="ph ph-pencil me-2"></i>
                {{ __('global.edit') }}
            </a>
        @endcan
        @can('people.saleman.delete')
            <div class="dropdown-divider"></div>
            <a href="{{ route('people.saleman.delete', $a->id) }}" class="dropdown-item" onclick="deleteRecord(event)">
