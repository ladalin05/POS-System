<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-end border-0 shadow-lg py-2" style="min-width: 160px; border-radius: 12px;">
        ...
        @can('people.suppliers.update')
            <a href="{{ route('people.suppliers.update', $row->id) }}" class="dropdown-item py-2 px-3 d-flex align-items-center">
        ...
        @can('people.suppliers.delete')
            ...
            <a href="{{ route('people.suppliers.delete', $row->id) }}" 
