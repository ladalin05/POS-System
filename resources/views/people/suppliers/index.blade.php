<x-app-layout>
    <x-basic.breadcrumb>
        <x-slot name="title">
            ...
            <span style="color: #646B72; font-size: 14px;">Manage your Suppliers</span>
        </x-slot>
        ...
        <div class="header-actions d-flex align-items-center gap-2">
            ...
            <a href="{{ route('people.suppliers.create') }}" class="btn btn-add-user d-flex align-items-center gap-2 text-white">
