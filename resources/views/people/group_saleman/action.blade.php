<div class="d-inline-flex dropdown ms-2">
    ...
    <div class="dropdown-menu dropdown-menu-end">
        @can('people.group_saleman.edit')
            <a href="{{ route('people.group_saleman.edit', $a->id) }}" class="dropdown-item">
                <i class="ph ph-pencil me-2"></i>
                {{ __('global.edit') }}
            </a>
        @endcan
        @can('people.group_saleman.delete')
            <div class="dropdown-divider"></div>
            <a href="{{ route('people.group_saleman.delete', $a->id) }}" class="dropdown-item" onclick="deleteRecord(event)">
