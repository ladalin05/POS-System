<div class="d-inline-flex dropdown ms-2">
    ...
    <div class="dropdown-menu dropdown-menu-end">
        @can('adjustment.edit')
            <a href="{{ route('adjustment.edit', $a->id) }}" class="dropdown-item">
        ...
        @can('adjustment.approve')
            @if(empty($a->status) || $a->status !== 'approved')
                ...
                <a href="{{ route('adjustment.approve', $a->id) }}" class="dropdown-item" onclick="approveAdjustment(event)">
        ...
        @can('adjustment.delete')
            <div class="dropdown-divider"></div>
            <a href="{{ route('adjustment.delete', $a->id) }}" class="dropdown-item" onclick="deleteRecord(event)">
