...
<body>
    ...
    <div id="wrapper">
        <header id="header" class="navbar">
            <div class="container" style="background-color: #42cac8;">
                <a class="navbar-brand" href="<?= site_url() ?>">
                    <span class="logo">
                        <span class="pos-logo-lg"><?= $Settings->site_name ?></span>
                        <span class="pos-logo-sm"><?= lang('pos') ?></span>
                    </span>
                </a>
                <div class="header-nav">
                    ...
                    <ul class="nav navbar-nav pull-right">
                        <li class="dropdown">
                            <a class=" pos-tip" title="<?= lang('dashboard') ?>" data-placement="bottom"
                        ...
                        <?php if ($pos_settings->pos_favorite_items == 1) { ?>
                            <li class="dropdown">
                                <a class="pos-tip" title="<?= lang('favorite') ?>" id="favorite">
                        ...
                        <li class="dropdown hidden">
                            <a class="pos-tip" title="<?= lang('shortcuts') ?>" data-placement="bottom" href="#"
                        ...
                        if ($this->config->item('ktv')) {
                            if ($Admin || $Owner || $GP['pos-customer_stock']) { ?>
                                <li class="dropdown">
                                    <a class="pos-tip" title="<?= lang('customer_stocks') ?>" data-placement="bottom"
                                        href="<?= site_url('pos/customer_stocks') ?>">
                                ...
                                <li class="dropdown">
                                    <a class="pos-tip" title="<?= lang('add_customer_stock') ?>" data-placement="bottom"
                                        href="<?= site_url('pos/add_customer_stock') ?>">
                                        <i class="fa fa-plus-circle"></i>
                                    </a>
                                </li>
                                <li class="dropdown">
                                    <a class="pos-tip" title="<?= lang('view_bill_screen') ?>" data-placement="bottom"
                        ...
                        <?php if ($pos_settings->pos_order_display == 1) { ?>
                            <li class="dropdown">
                                <a class="pos-tip" id="spinner-toggle" title="<?= lang('spinner_toggle') ?>"
                        ...
                        <?php if ($pos_settings->table_enable == 1) {
                            if ($sid) {
                                ...
                                <li class="dropdown hidden">
                                    <a class="pos-tip" id="opened_salemans" title="<?= lang('salemans') ?>"
                                        data-placement="bottom" data-html="true"
                                        href="<?= site_url('pos/opened_salemans/' . $sid) ?>" data-toggle="ajax">
                                        <i class="fa fa-user"></i>
                                    </a>
                                </li>
                                <li><a class="pos-tip cl-danger" href="<?= site_url("pos/add_table"); ?>"
                                        style="color:#ffffff;font-weight:bold;"><?= $billsTable->name ?></a></li>
                            <?php } else { ?>
                                <li><a class="pos-tip cl-danger" href="<?= site_url("pos/add_table"); ?>"
                                        style="color:#ffffff;font-weight:bold;"><i class="fa fa-toggle-off"
                        ...
                        <li class="dropdown">
                            <a class="pos-tip" id="opened_bills" title="<?= lang('suspended_sales') ?>"
                                ...
                                if ($count_suspend) {
                                    echo '<span class="posnumber white">' . ($count_suspend) . '</span>';
                                }
                                ?>
                            </a>
                        </li>
                        <?php if ($Admin || $Owner && ($pos_settings->table_enable == 1 && $sid)) { ?>
                            <li class="dropdown">
                                <a class="pos-tip" id="opened_bill_items" title="<?= lang('opened_bill_items') ?>"
                                    data-placement="bottom" data-html="true"
                                    href="<?= site_url('pos/opened_bills_items/' . $sid) ?>" data-toggle="ajax">
                        ...
                        <li class="dropdown">
                            <a class="pos-tip" id="register_items" title="<?= lang('register_items') ?>"
                                data-placement="bottom" data-html="true" href="<?= site_url('pos/register_items') ?>"
                                data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-folder-open-o"></i>
                            </a>
                        </li>
                        <li class="dropdown">
                            <a class="pos-tip" id="register_details" title="<?= lang('register_details') ?>"
                                data-placement="bottom" data-html="true" href="<?= site_url('pos/register_details') ?>"
                                data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-check-circle"></i>
                            </a>
                        </li>
                        <li class="dropdown">
                            <a class="pos-tip" id="close_register" title="<?= lang('close_register') ?>"
                                data-placement="bottom" data-html="true" data-backdrop="static"
                                href="<?= site_url('pos/close_register') ?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-times-circle"></i>
                            </a>
                        </li>
                        <li class="dropdown">
                            <a target="_blank" class="pos-tip" id="add_expense" title="<?= lang('add_expense') ?>"
                                href="<?= site_url('purchases/add_expense') ?>">
                                <i class="fa fa-dollar"></i>
                            </a>
                        </li>
                        <li class="dropdown">
                            <a class="pos-tip" id="today_sale" title="<?= lang('today_sale') ?>" data-placement="bottom"
                                data-html="true" href="<?= site_url('pos/today_sale') ?>" data-toggle="modal"
                                data-target="#myModal">
                        ...
                        <?php if ($Owner || $Admin) { ?>
                            <li class="dropdown hidden-xs">
                                <a class="pos-tip" title="<?= lang('list_open_registers') ?>" data-placement="bottom"
                                    ...
                                    if ($count_open) {
                                        echo '<span class="posnumber white">' . ($count_open) . '</span>';
                                    }
                                    ?>
                                </a>
                            </li>
                    ...
                    <div id="pos">
                        ...
                        <div class="col-xs-6">
                            ...
                            <div id="printhead">
                                ...
                                echo $this->lang->line("date") . " " . $this->bms->hrld(date('Y-m-d H:i:s'));
                                ?>
                            </div>
                            <div id="left-top">
                                <div
                                ...
                                <input type="hidden" name="date" id="podate" value="<?= date("d/m/Y H:i:s"); ?>" />
                                    ...
                                    <div class="input-group">
                                        ...
                                        <?php if ($Owner || $Admin || $GP['customers-add']) { ?>
                                            <div class="input-group-addon no-print" style="padding: 2px 8px;">
                                                <a href="<?= site_url('customers/add'); ?>" id="add-customer" class="external"
                                                    data-toggle="modal" data-target="#myModal">
                            ...
                            <div id="print">
                                        ...
                                        <table
                                            ...
                                            <thead>
                                                ...
                                                <?php if ($Settings->qty_operation == 1) { ?>
                                                    <tr>
                                                        <th
                                                            style="color:white; text-align:center; background-color:#428BCA; border:1px solid #357EBD">
                                                            <?= lang('width') ?></th>
                                                        <th
                                                            style="color:white; text-align:center; background-color:#428BCA; border:1px solid #357EBD">
                                                            <?= lang('height') ?></th>
                                ...
                                <div id="left-bottom">
                                    ...
                                    <?php $suspend_option = ($pos_settings->table_enable);
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-xs-4">
                                                        <div class="row">
                                                            <div class="btn-group-vertical btn-block">
                                                                <input type="hidden" class="item_order_count"
                                                                    value="<?= $count; ?>" />
                                                                <input type="hidden" class="item_ordered" />
                                                                <?php if ($billsTable != false) { ?>
                                                                    <input type="hidden" value="<?= $billsTable->table_name ?>"
                                                                        time="<?= date("d/m/Y H:i", strtotime($billsTable->date)); ?>"
                                                                        class="add_suspend_item"
                                                                        id="<?= $billsTable->table_id ?>" />
                                                                    <a href="<?= site_url("pos/add_table?v=1&bill_id=" . $billsTable->id) ?>"
                                                                        id="move_suspend" type="button"
                                                                        class="btn cl-primary btn-block">
                                                                        <i class="fa fa-retweet" aria-hidden="true"></i>
                                                                        <?= lang('move'); ?>
                                                                    </a>
                                                                <?php } else { ?>
                                                                    <a disabled class="btn cl-primary"><i class="fa fa-retweet"
                                                                            aria-hidden="true"></i> <?= lang('move'); ?></a>
                                                                <?php } ?>
                                                                <?php if ($billsTable != false) { ?>
                                                                    <a hreff="<?= site_url("pos/delete_suspend/" . $billsTable->table_id); ?>"
                                                                        class="btn cl-primary btn-block btn-flat delete_suspend">
                                                                        <i class="fa fa-times" aria-hidden="true"></i>
                                                                        <?= lang('delete'); ?>
                                                                    </a>
                                                                <?php } else { ?>
                                                                    <a disabled class="btn cl-primary"><i class="fa fa-times"
                                                                            aria-hidden="true"></i> <?= lang('delete'); ?></a>
                                                                <?php } ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xs-4">
                                                        <div class="row">
                                                            <div class="btn-group-vertical btn-block">
                                                                ...
                                                                <button <?= $payment_block ?> type="button"
                                                ...
                                                <?php } else { ?>
                                                    <div class="col-xs-4" style="padding: 0;">
                                                        <div class="btn-group-vertical btn-block">
                                                            <button type="button" class="btn cl-primary btn-block btn-flat"
                                                                id="suspend">
                                                                <?= lang('suspend'); ?>
                                                            </button>
                                                            <?php if ($sid) { ?>
                                                                <a hreff="<?= site_url("pos/delete_suspend/" . $sid); ?>"
                                                                    class="btn cl-primary btn-block btn-flat delete_suspend"
                                                                    id="reset">
                                                                    <?= lang('cancel'); ?>
                                                                </a>
                                                    ...
                                                    <?php if ($pos_settings->table_enable == 1) { ?>
                                                        ...
                                                        <div class="col-xs-4" style="padding: 0;">
                                                            <button type="button" class="btn cl-success btn-block payment"
                                                                id="payment" style="height:67px;">
                                                                <i class="fa fa-money"
                                                                    style="margin-right: 5px;"></i><?= lang('payment'); ?>
                                                            </button>
                                                        </div>
                                                    <?php } else { ?>
                                                        ...
                                                        <?php if ($pos_settings->pos_payment == 0) { ?>
                                                            <div class="col-xs-4" style="padding: 0;">
                                                                <input type="submit" id="submit_pos_payment" value="Submit Sale"
                                                                    style="display: none;" />
                                                                <button id="pos_payment" type="button" class="btn cl-danger btn-block"
                                                                    style="height:67px;">
                                                                    <i class="fa fa-money"
                                                                        style="margin-right: 5px;"></i><?= lang('save'); ?>
                                                                </button>
                                                            </div>
                                                        <?php } else { ?>
                                                            <div class="col-xs-4" style="padding: 0;">
                                                                <button type="button" class="btn cl-danger btn-block payment"
                                                                    id="payment" style="height:67px;">
                                                                    <i class="fa fa-money"
                                                                        style="margin-right: 5px;"></i><?= lang('payment'); ?>
                                                                </button>
                                    ...
                                    <input name="shipping" type="hidden"
                                        value="<?= $suspend_sale ? $suspend_sale->shipping : '0'; ?>" id="posshipping">
                        ...
                        <div class="col-xs-6">
                            <?php if ($pos_settings->quick_pos == 1) { ?>
                                ...
                                <div id="b-top">
                                    <div class="col-sm-6 col-md-6 col-lg-6 col-xs-6 cl-primary">
                                        <div class="row">
                                            <table style="width:100%;" id="table-money">
                                                <tr>
                                                    <td style='width:50%;'>
                                                        <button style='width:100%; height:40px;' type='button'
                                                            class='btn btn-money cl-primary' id='quick_payble_usd'>
                                                            <?= lang("USD") ?>
                                                        </button>
                                                    </td>
                                                    <td style="width:50%">
                                                        <button style='width:100%; height:40px;' type='button'
                                                            class='btn btn-money cl-primary' id='quick_payble_khr'>
                                                            <?= lang("KHR") ?>
                                                        </button>
                                                    </td>
                                                </tr>
                                                <?php foreach ($usd_notes as $i => $usd_note) {
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td><button style='width:100%; height:40px;' type='button'
                                                                class='btn btn-money cl-primary quick_cash_usd'><?= $usd_note ?></button>
                                                        </td>
                                                        <td><button style='width:100%; height:40px;' type='button'
                                                                class='btn btn-money cl-primary quick_cash_khr'><?= $khr_note ?></button>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                                <tr>
                                                    <td>
                                                        <button style='width:100%; height:40px;' type='button'
                                                            class='btn btn-money cl-primary' id='quick_clear_usd'>
                                                            <i class="fa fa-eraser" aria-hidden="true"></i>
                                                        </button>
                                                    </td>
                                                    <td>
                                                        <button style='width:100%; height:40px;' type='button'
                                                            class='btn btn-money cl-primary' id='quick_clear_khr'>
                                                            <i class="fa fa-eraser" aria-hidden="true"></i>
                                                        </button>
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6 col-xs-6 cl-warning">
                                        <div class="row">
                                            <table style="width:100%;" id="table-cal">
                                                <tr>
                                                    <td style="width:25%;"><button style='width:100%; height:80px;'
                                                            type='button'
                                                            class='btn btn-key cl-warning expression'>7</button></td>
                                                    <td style="width:25%;"><button style='width:100%; height:80px;'
                                                            type='button'
                                                            class='btn btn-key cl-warning expression'>8</button></td>
                                                    <td style="width:25%;"><button style='width:100%; height:80px;'
                                                            type='button'
                                                            class='btn btn-key cl-warning expression'>9</button></td>
                                                    <td style="width:25%;" rowspan="2"><button
                                                            style='width:100%; height:160px;' type='button'
                                                            class='btn btn-key cl-warning' id="backspace"><img
                                                                src="<?= base_url('assets/images/delete.png') ?>"
                                                                width="25" /></button></td>
                                                </tr>
                                                <tr>
                                                    <td><button style='width:100%; height:80px;' type='button'
                                                            class='btn btn-key cl-warning expression'>4</button></td>
                                                    <td><button style='width:100%; height:80px;' type='button'
                                                            class='btn btn-key cl-warning expression'>5</button></td>
                                                    <td><button style='width:100%; height:80px;' type='button'
                                                            class='btn btn-key cl-warning expression'>6</button></td>

                                                </tr>
                                                <tr>
                                                    <td><button style='width:100%; height:80px;' type='button'
                                                            class='btn btn-key cl-warning expression'>1</button></td>
                                                    <td><button style='width:100%; height:80px;' type='button'
                                                            class='btn btn-key cl-warning expression'>2</button></td>
                                                    <td><button style='width:100%; height:80px;' type='button'
                                                            class='btn btn-key cl-warning expression'>3</button></td>
                                                    <td rowspan="2"><button style='width:100%; height:160px;' type='button'
                                                            class='btn btn-key cl-warning' id="erase_all">C</button></td>
                                                </tr>
                                                <tr>
                                                    <td><button style='width:100%; height:80px;' type='button'
                                                            class='btn btn-key cl-warning expression'>0</button></td>
                                                    <td><button style='width:100%; height:80px;' type='button'
                                                            class='btn btn-key cl-warning expression'>.</button></td>
                                                    <td><button style='width:100%; height:80px;' type='button'
                                                            class='btn btn-key cl-danger' value="USD"
                                                            id="lan_toggle"><?= lang('USD') ?></button></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
                                        <div class="row">
                                            <table class="table table-borderless"
                                                style="white-space:nowrap; margin-bottom:5px;" id="table-money-info">
                                                <tr>
                                                    <th></th>
                                                ...
                                                <tr>
                                                    <th><?= lang("grand_total") ?><input type="hidden" value="0"
                                                            id="qgtotal" /></th>
                                                    <th>: <span id="qgtotal_usd"
                                                            style="float:right;"><?= $this->bms->formatOtherMoney(0) ?></span>
                                                    </th>
                                                    <th> <span id="qgtotal_khr"
                                                            style="float:right;"><?= $this->bms->formatKhMoney(0) ?></span>
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th><?= lang("paying") ?><input name="gpaying" type="hidden" value="0"
                                                            id="gpaying" /></th>
                                                    <th style="padding-top:0;padding-bottom:0;"><input type="text"
                                                            name="qpaying_usd" class="form-control text-right qpaying"
                                                            id="qpaying_usd" /></th>
                                                    <th style="padding-top:0;padding-bottom:0;"><input type="text"
                                                            name="qpaying_khr" class="form-control text-right qpaying"
                                                            id="qpaying_khr" /></th>
                                                </tr>

                                                <tr class="box_award_point" style="display:none !important">
                                                    <th><?= lang("award_point"); ?> (<span
                                                            id="d_t_award_point"><?= $this->bms->formatMoney(0) ?></span>)
                                                        </td>
                                                    <th style="padding-top:0;padding-bottom:0;">
                                                        <input type="hidden" id="t_award_point" />
                                                        <input type="text" id=""
                                                            class="form-control text-right qaward_point" />
                                                    </th>
                                                </tr>
                                                ...
                                                <?php if ($pos_settings->pos_multi_payment == 1) { ?>
                                                    <tr id="rowMultiPayment">
                                                        <th colspan="3">
                                                            <button type="button"
                                                                class="btn cl-primary btn-other col-md-12 addMorePayment">
                                                ...
                                                <?php } ?>
                                                <tr>
                                                    <th><?= lang("balance") ?><input name="qbalance" type="hidden" value="0"
                                                            id="qbalance" /></th>
                                                    <th> : <span id="qbalance_usd"
                                                            style="float:right;color:red;"><?= $this->bms->formatOtherMoney(0) ?></span>
                                                    </th>
                                                    <th> <span id="qbalance_khr"
                                                            style="float:right;color:red;"><?= $this->bms->formatKhMoney(0) ?></span>
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th><?= lang("change") ?></th>
                                                    <th>: <span id="qchange_usd"
                                                            style="float:right;"><?= $this->bms->formatOtherMoney(0) ?></span>
                                                    </th>
                                                    <th> <span id="qchange_khr"
                                                            style="float:right;"><?= $this->bms->formatKhMoney(0) ?></span>
                                                    </th>
                                                </tr>
                                            </table>
                                ...
                                <div id="b-bottom">
                                    <div class="col-sm-3">
                                        <div class="row">
                                            <?php if ($sid) { ?>
                                                <a hreff="<?= site_url("pos/delete_suspend/" . $sid); ?>"
                                                    style="line-height: 29px;height:40px;text-transform:uppercase;"
                                                    class="btn btn-other cl-warning btn-block btn-flat delete_suspend"
                                                    id="reset">
                                                    <i class="fa fa-times-circle-o" aria-hidden="true"></i>
                                                    <?= lang('clear'); ?>
                                                </a>
                                            <?php } else { ?>
                                                <button type="button" style="height:40px;text-transform:uppercase;"
                                                    class="btn btn-other cl-warning btn-block btn-flat" id="reset">
                                                    <i class="fa fa-times-circle-o" aria-hidden="true"></i>
                                                    <?= lang('cancel'); ?>
                                                </button>
                                            <?php } ?>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="row">
                                            <button type="button" style="height:40px;text-transform:uppercase;"
                                                class="btn btn-other cl-primary btn-block btn-flat" id="suspend">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <input type="submit" id="submit_quick_pos" value="Submit Sale"
                                                style="display: none;" />
                                            <button id="quick_payment" type="button"
                                                style="height:40px;text-transform:uppercase;"
                                                class="btn btn-other cl-danger btn-block">
                                    ...
                                    <div id="panel-top">
                                        <?php if ($pos_settings->pos_category_fix == 1) { ?>
                                            <div id="quick-categories">
                                                <div class="col-sm-1 col-md-1 col-lg-1 col-xs-1">
                                                    <div class="row">
                                                        <button class="btn cl-primary" title="<?= lang('previous') ?>"
                                                            type="button" id="previous_c">
                                                ...
                                                <div class="col-sm-1 col-md-1 col-lg-1 col-xs-1">
                                                    <div class="row">
                                                        <button class="btn cl-primary" title="<?= lang('next') ?>" type="button"
                                                            id="next_c">
                                        ...
                                        <div id="product-search" style="padding-top:5px;">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control sp_code"
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control sp_name"
                                        ...
                                        <div id="ajaxproducts">
                                            ...
                                            <div id="panel-bottom" class="btn-group btn-group-justified pos-grid-nav">
                                                ...
                                                if ($Owner || $Admin || $GP['sales-add_gift_card']) {
                                                    if ($pos_settings->table_enable == 0) {
                                                        ?>
                                                        <div style="display:none" class="btn-group">
                                                            <button style="z-index:10003;" class="btn cl-primary pos-tip"
                                                                type="button" id="sellGiftCard" title="<?= lang('sell_gift_card') ?>">
                                                                <i class="fa fa-credit-card" id="addIcon"></i>
                                                                <?= lang('sell_gift_card') ?>
                                                            </button>
                                                        </div>
                                                    <?php
                                                ...
                                                ?>
                                                <div class="btn-group">
                                                    <button style="z-index:10004;" class="btn cl-primary pos-tip"
    ...
    <?php if ($pos_settings->pos_category_fix != 1 && $pos_settings->quick_pos != 1) { ?>
        <div class="rotate btn-cat-con">
            ...
            <button type="button" id="open-category"
                class="btn btn-primary open-category"><?= lang('categories'); ?></button>
        </div>
    <?php } ?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                        ...
                        <div class="col-md-10 col-sm-9">
                            ...
                            <div class="payment-cash">
                                ...
                                <table class="table table-bordered table-condensed table-striped">
                                    <tbody>
                                        <tr>
                                            <th width="50%" height="45" class="text-left bold"><?= lang("currency"); ?>
                                            </th>
                                            <?php
                                            $allCurrencies = $this->site->getAllCurrencies();
                                            $column = (2 + count($allCurrencies));
                                        ...
                                        <tr>
                                            <td width="50%" height="45" class="text-left bold">
                                                <?= lang("total_items"); ?></td>
                                        ...
                                        <tr>
                                            ...
                                            foreach ($allCurrencies as $currency) {
                                                ...
                                                <td class="text-right"><span class="total_payable"
                                                        base_rate="<?= $base_currency->rate ?>" rate="<?= $currency->rate ?>"
                                                        id="total_payable">0</span></td>
                                            <?php } ?>
                                        </tr>
                                        <tr>
                                            <td width="50%" height="45" class="text-left bold">
                                            ...
                                            foreach ($allCurrencies as $currency) {
                                                ...
                                                ?>
                                                <td class="text-right">
                                                    <input name="camount[]" base_rate="<?= $base_currency->rate ?>"
                                                        rate="<?= $currency->rate ?>" type="text"
                                                        class="form-control camount <?= ($currency->code == $base_currency->code ? "base_amount" : ""); ?>"
                                                        class="text-right" />
                                                </td>
                                            <?php } ?>
                                        </tr>
                                        <?php if ($this->config->item('award_point') && $pos_settings->quick_pos != 1) { ?>
                                            <tr class="box_award_point" style="display:none !important">
                                                <td width="50%" height="45" class="text-left bold">
                                                    <?= lang("award_point"); ?> (<span
                                                        id="d_t_award_point"><?= $this->bms->formatMoney(0) ?></span>)</td>
                                                <td class="text-right">
                                                    <input type="hidden" id="t_award_point" />
                                                    <input type="text" id="" class="form-control text-right award_point" />
                                                </td>
                                                <td></td>
                                            </tr>
                                        <?php } ?>
                                        ...
                                        <tr>
                                            <td width="50%" height="45" class="text-left bold"><?= lang("balance"); ?>
                                            </td>
                                            <?php
                                            $count_currency = 0;
                                            foreach ($allCurrencies as $currency) {
                                                ...
                                                $count_currency++;
                                                ?>
                                                <td class="text-right"><span class="balance_1"
                                                        base_rate="<?= $base_currency->rate ?>" rate="<?= $currency->rate ?>"
                                                        id="balance_1">0</span></td>
                                            <?php } ?>
                                        </tr>
                        ...
                        <div class="col-md-2 col-sm-3 text-center">
                            ...
                            <div class="btn-group btn-group-vertical">
                                ...
                                foreach (lang('quick_cash_notes') as $cash_note_amount) {
                                    echo '<button type="button" class="btn btn-lg cl-primary quick-cash">' . $cash_note_amount . '</button>';
                                }
                                ?>
                                <button type="button" class="btn btn-lg cl-danger"
                ...
                <div class="modal-footer">
                    <button class="btn btn-block btn-lg cl-primary" id="submit-sale"><?= lang('submit'); ?></button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="pr_popover_content">
                    <form class="form-horizontal" role="form">
                        ...
                        <?php if (($Admin || $Owner || $GP['pos-return_order'] == 1) && $pos_settings->table_enable == 1) { ?>
                            <div class="form-group hidden">
                                <label for="return_quantity"
                                    class="col-sm-4 control-label"><?= lang('return_quantity') ?></label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label for="saleman" class="col-sm-4 control-label"><?= lang('saleman') ?></label>
                            <div class="col-sm-8">
                        ...
                        <?php if ($this->config->item('product_currency') == true) { ?>
                            <div class="form-group">
                                <label for="pproduct_currency"
                                    class="col-sm-4 control-label"><?= lang('product_currency') ?></label>
                                <div class="col-sm-8">
                        ...
                        <?php if ($Settings->product_additional) { ?>
                            <div class="form-group">
                                <label for="paditional"
                                    class="col-sm-4 control-label"><?= lang('product_additional') ?></label>
                                <div class="col-sm-8">
                        ...
                        <?php if ($Settings->product_discount && ($Owner || $Admin || $this->session->userdata('allow_discount'))) { ?>
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label for="tpdiscount"
                                            class="col-sm-4 control-label"><?= lang('discount') ?></label>
                                        <div class="col-sm-8">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_input('gcexpiry', $this->bms->hrsd(date("Y-m-d", strtotime("+2 year"))), 'class="form-control date" id="gcexpiry"'); ?>
                    </div>
                        ...
                        <?php if ($Settings->overselling && ($Owner || $Admin || $GP['products-add'])) { ?>
                            <div class="form-group">
                                <label for="add_product"
                                    class="col-sm-4 control-label"><?= lang('add_to_list_products') ?></label>
                                <div class="col-sm-8">
    ...
    if ($suspend_option != 0) {
        foreach ($types as $type) { ?>
            <div id="order_tbl_<?= strtolower($type->name) ?>" data-item="<?= strtolower($type->name) ?>"
                class="hidden print_order">
                <span id="order_span_<?= strtolower($type->name) ?>"></span>
                <table id="order-table-<?= strtolower($type->name) ?>" class="prT table table-striped" style="margin-bottom:0;"
                    width="100%"></table>
            </div>
        <?php }
    }
    ...
    <span class="hidden"
        id="bill_address"><?php echo $biller->address . "<br>" . $biller->city . " " . $biller->postal_code . " " . $biller->state . "<br>" . $biller->country; ?></span>
    ...
    <script type="text/javascript">
        ...
        var protect_delete = <?php if (!$Owner && !$Admin) {
            ...
            echo '0';
        } ?>, billers = <?= json_encode($posbillers); ?>, biller = <?= json_encode($posbiller); ?>, pos_delorder = <?php if (!$Owner && !$Admin && $GP['pos-delete_order'] != 1) {
                 echo '1';
             } else {
                 echo '0';
             } ?>;
        ...
        $(document).ready(function () {
            ...
            function select_customer(e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        <?php }
                        if ($this->config->item("award_point")) { ?>
                            $("#t_award_point").val(data.award_point);
                            if (data.award_point > 0) {
                                $(".box_award_point").css("display", "table-row");
                                $("#d_t_award_point").html(formatMoney(data.award_point));
                            } else {
                                $(".box_award_point").css("display", "none");
                            }
                        <?php } ?>
            ...
            <?php } else if ($this->session->userdata('remove_posls')) { ?>
                ...
                <?php $this->bms->unset_data('remove_posls');
                }
            ...
            $(document).on('click', '.addMorePayment', function () {
                ...
                multi_payment += '<?= $this->bms->cash_opts(false, true, false, true); ?>';
        ...
        <?php if ($pos_settings->remote_printing == 1) { ?>
            ...
            function Popup(data) {
                var mywindow = window.open('', 'bms_pos_print', 'height=500,width=300');
