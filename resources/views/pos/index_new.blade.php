<x-guest-layout>
    ...
    <script>
        ...
        const categories = [
            ...
            { id: '1', name: 'Mobile', icon: 'fa-mobile-screen' },
            { id: '2', name: 'Laptop', icon: 'fa-laptop' },
            { id: '3', name: 'Watch', icon: 'fa-stopwatch' }
        ];

        const products = [
            { id: 101, cat_id: '1', name: 'iPhone 15 Pro', price: 1099, img: 'https://cdn-icons-png.flaticon.com/512/0/191.png', stock: 10 },
            { id: 102, cat_id: '2', name: 'MacBook Air', price: 999, img: 'https://cdn-icons-png.flaticon.com/512/428/428001.png', stock: 5 },
            { id: 103, cat_id: '3', name: 'Apple Watch', price: 399, img: 'https://cdn-icons-png.flaticon.com/512/2928/2928817.png', stock: 15 },
            { id: 104, cat_id: '1', name: 'Google Pixel 8', price: 699, img: 'https://cdn-icons-png.flaticon.com/512/2586/2586488.png', stock: 8 }
        ];
