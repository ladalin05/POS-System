<div class="d-inline-flex dropdown ms-2">
    ...
    <div class="dropdown-menu dropdown-menu-end" style="">
        @can('dbmockup.projects.edit')
            <a href="{{ route('dbmockup.projects.edit', $a->id) }}" class="dropdown-item">
                <i class="ph ph-pencil me-2"></i>
                {{ __('global.edit') }}
            </a>
        @endcan
        @can('dbmockup.projects.delete')
            <div class="dropdown-divider"></div>
            <a href="{{ route('dbmockup.projects.delete', $a->id) }}" class="dropdown-item" onclick="deleteRecord(event)">
