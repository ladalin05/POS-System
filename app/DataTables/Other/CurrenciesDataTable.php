...
class CurrenciesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return datatables()
            ...
            ->addColumn('action', fn($row) => view('other.currencies.action', compact('row')))
     ...
     */
    public function query(Currencies $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('rate')->title(__('global.exchange_rate')),
